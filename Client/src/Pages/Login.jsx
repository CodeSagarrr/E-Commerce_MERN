    ...
    <div className='flex w-full justify-center items-center h-[90vh] bg-[#246b91]'>
      <div className='md:w-[32%] w-[100%] mx-10 h-[65vh] border  rounded-3xl '>
        ...
        <form className='flex flex-col justify-center h-[66%] w-[90%] mx-12  '>
          ...
          <input className='w-[90%] h-[10%]  rounded-md p-2 outline-none' type='text' placeholder='Name' name='username'   onChange={handleLoginChange}/>
          <label className='font-bold text-xl mt-5 mb-1 text-white'>Password</label>
          <input className='w-[90%] h-[10%]  rounded-md p-2  outline-none' type='password' placeholder='Password' name='password' onChange={handleLoginChange} />
          <button className='w-[90%] h-[10%] rounded-md mt-10 bg-[#0f0f0f] text-white text20old outline-none' onClick={handleLogin}>Login</button>
        </form>
        <ToastContainer/>
